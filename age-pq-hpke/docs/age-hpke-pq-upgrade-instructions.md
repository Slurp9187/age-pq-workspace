### Complete Revised Instructions for Upgrading `age-pq-hpke` for Extensible ML-KEM Variants
...
- **Crate Name**: `age-pq-hpke` (Rust package / GitHub repo name; import as `age_pq_hpke`). Describes HPKE with post-quantum KEM in the age ecosystem.
